...
<template>
  <div class="main">
    ...
    <footer class="footer">
      <div>
        <img class="mix-blend-darken" src="../wroth.jpg" alt="wellington roth" width="100px" height="100px">
      </div>
      <ul class="socials-list">
        ...
        <li>
          <a href="https://www.linkedin.com/in/wellingtonroth/" target="_blank">
        ...
        <li>
          <a href="https://www.instagram.com/wellrothh/" target="_blank">
            <svg class="svg-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30px" height="30px">   
